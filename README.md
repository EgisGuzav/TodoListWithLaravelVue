      ...
      <a href="#getting-started">Getting Started</a>
		...
		<li>
			...
			<ul>
				...
				<li><a href="#setting-up-vue-3-in-a-project">Setting up Vue 3 in a project</a></li>
				<li><a href="#installation-of-bootstrap-5">Installation of Boostrap 5</a></li>
				<li><a href="#setting-up-bootstrap-5-in-a-project">Setting up Boostrap 5 in a project</a></li>
			</ul>
		</li>
...
- [ ] Multi-language support using [Laravel localization to Vue](https://github.com/kg-bot/laravel-localization-to-vue). I haven't been able to get it to work /:
